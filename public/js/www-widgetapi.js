...
function Da(a){this.next=function(b){qa(a.h);a.h.l?b=Ba(a,a.h.l.next,b,a.h.B):(a.h.B(b),b=Ca(a));return b};
this.throw=function(b){qa(a.h);a.h.l?b=Ba(a,a.h.l["throw"],b,a.h.B):(ra(a.h,b),b=Ca(a));return b};
...
;function Qd(a){var b,c;J.call(this);var d=this;this.B=this.j=0;this.K=null!==a&&void 0!==a?a:{L:function(e,f){return setTimeout(e,f)},
...
window.addEventListener("offline",this.m);window.addEventListener("online",this.m);this.B||Sd(this)}
v(Qd,J);Qd.prototype.dispose=function(){window.removeEventListener("offline",this.m);window.removeEventListener("online",this.m);this.K.W(this.B);delete Qd.h};
Qd.prototype.F=function(){return this.i};
function Sd(a){a.B=a.K.L(function(){var b;return z(function(c){if(1==c.h)return a.i?(null===(b=window.navigator)||void 0===b?0:b.onLine)?c.o(3):w(c,Rd(a),3):w(c,Rd(a),3);Sd(a);c.h=0})},3E4)}
...
function Pe(a){a.v||(a.v=!0,ce(a.B,a))}
function Me(a){var b=null;a.i&&(b=a.i,a.i=b.next,b.next=null);a.i||(a.l=null);return b}
Ee.prototype.B=function(){for(var a;a=Me(this);)Ne(this,a,this.h,this.u);this.v=!1};
...
E(Ke,Ua);Ke.prototype.name="cancel";function K(a){kd.call(this);this.u=1;this.j=[];this.m=0;this.h=[];this.i={};this.B=!!a}
...
this.G=a.G;this.S=a.S;this.Ea=a.Ea;this.Da=a.Da;this.s&&(!this.A||this.A("networkless_logging"))&&rj(this)}
function rj(a){a.s&&!a.ea&&(a.h=!0,a.oa&&Math.random()<=a.na&&a.D.hb(a.s),sj(a),a.G.F()&&a.ia(),a.A&&!a.A("use_new_nwl_initialization")&&(a.G.Y(a.Ea,a.ia.bind(a)),a.G.Y(a.Da,a.Ia.bind(a))))}
...
uj(d,g)})}else this.S(a,b,this.A&&this.A("nwl_skip_retry")&&c)};
...
b.options.onError=function(e,f){var g;return z(function(h){switch(h.h){case 1:g=xj(f);if(!(a.A&&a.A("nwl_consider_error_code")&&g||a.A&&!a.A("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.sa)){h.o(2);break}if(!a.G.T){h.o(3);break}return w(h,a.G.T(),3);case 3:if(a.G.F()){h.o(2);break}c(e,f);if(!a.A||!a.A("nwl_consider_error_code")||void 0===(null===b||void 0===b?void 0:b.id)){h.o(6);break}return w(h,a.D.Fa(b.id,a.s,!1),6);case 6:return h.return();case 2:if(a.A&&a.A("nwl_consider_error_code")&&
...
signal:f}),5);case 5:g=!0;case 3:xa(h);N("use_cfr_monitor")&&Xj().requestComplete("generate_204",g);b.u=void 0;b.B&&Eg.W(b.B);g!==b.j&&(b.j=g,b.j&&b.m?Od(b,"ytnetworkstatus-online"):b.m&&Od(b,"ytnetworkstatus-offline"));d(g);ya(h);break;case 2:ua(h),g=!1,h.o(3)}})})};
...
function ik(a,b){a.ta?a.j?(Eg.W(a.O),a.O=Eg.L(function(){a.B!==b&&(Od(a,b),a.B=b,a.j=Q())},a.ta-(Q()-a.j))):(Od(a,b),a.B=b,a.j=Q()):Od(a,b)}
;var jk;function kk(){qj.call(this,{D:{hb:Lj,aa:Kj,Na:Hj,ob:Ij,Fa:Jj,set:Fj},G:lk(),handleError:Yf,ba:Zf,S:mk,now:Q,ab:ak,K:Dg(),Ea:"publicytnetworkstatus-online",Da:"publicytnetworkstatus-offline",oa:!0,na:.1,sa:tg("potential_esf_error_limit",10),A:N,ea:!(hi()&&(N("embeds_web_nwl_disable_nocookie")?"www.youtube-nocookie.com"!==Cb(document.location.toString()):1))});this.j=new De;N("networkless_immediately_drop_all_requests")&&Mj();pj("LogsDatabaseV2")}
...
hl[c]=b}
var hl=null;function il(a,b,c){this.m=this.h=this.i=null;this.j=0;this.u=!1;this.v=[];this.l=null;this.I={};if(!a)throw Error("YouTube player element ID required.");this.id=Na(this);this.B=c;this.setup(a,b)}
...
function ll(a,b){b=b.split(".");if(2===b.length){var c=b[1];a.B===b[0]&&kl(a,c)}}
...
function jl(a,b,c){a.l.l||(c={target:a,data:c},a.l.ca(b,c),dl(a.B+"."+b,c))}
