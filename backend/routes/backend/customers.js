...
router.post('/invoice/create/:id', userImage().none(), customer.save_invoice);
...
router.post('/create/bulk', userImage().single('customer_image'), customer.bulk);
router.post('/create/single', userImage().single('customer_image'), customer.single);
...
router.post('/edit/:id', userImage().single('customer_image'), customer.edit);
