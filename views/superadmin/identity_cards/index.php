    ...
    <div class="row d-print-none">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="page-title">
                        <i class="mdi mdi-account-card-details title_icon"></i> <?php echo get_phrase('identity'); ?>
                        <a href="<?php echo route('identity_cards/id_template'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"> <i class="mdi mdi-airplay"></i> <?php echo get_phrase('id_layout'); ?></a>
                    </h4>
                </div> <!-- end card body-->
            </div> <!-- end card -->
        </div><!-- end col-->
...
<?php elseif($working_page == 'id_template'): ?>
    <?php include 'id_template.php'; ?>
...
var showAllStudents = function() {
    ...
    if(class_id != "" && section_id!= ""){
        $.ajax({
            url: '<?php echo route('identity_cards/filter/') ?>'+class_id+'/'+section_id,
            success: function(response){
